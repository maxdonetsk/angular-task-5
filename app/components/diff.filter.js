        ...
        .filter('diff', function ($sce) {
            ...
            function diffString2(o, n) {
                ...
                for (i = 0; i < out.o.length; i++) {
                    ...
                    if (out.o[i].text) {
                        os += '<insacc style="background-color: ' + colors[i] + '">' +
                                escape(out.o[i].text) + '</insacc>' + oSpace[i];
                    } else {
                        os += '<del>' + escape(out.o[i]) + '</del>' + oSpace[i];
                    }
                }
                ...
                for (i = 0; i < out.n.length; i++) {
                    if (out.n[i].text) {
                        ns += '<insacc style="background-color: ' + colors[out.n[i].row] + '">' +
                                escape(out.n[i].text) + '</insacc>' + nSpace[i];
                    } else {
                        ns += '<ins>' + escape(out.n[i]) + '</ins>' + nSpace[i];
                    }
                }
